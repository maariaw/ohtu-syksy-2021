...
class TestOstoskori(unittest.TestCase):
    ...
    # step 5
    def test_kahden_eri_tuotteen_lisaamisen_jalkeen_korin_hinta_tuotteiden_hintojen_summa(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.mehu)
    ...
    # step 12
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_korin_ostosoliolla_tuotteen_nimi_ja_lukumaara_2(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    # step 13
    def test_kun_korin_kahdesta_samasta_tuotteesta_poistetaan_yksi_jaa_koriin_ostos_jossa_lukumaara_yksi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    # step 14
    def test_kun_koriin_lisataan_tuote_ja_poistetaan_tuote_kori_on_tyhja(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.poista_tuote(self.maito)
